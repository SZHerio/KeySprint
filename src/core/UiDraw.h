...
void DrawBoldFittedText(Game* game, Font font, const char* text, Vector2 position, float maxWidth, float fontSize, float spacing, Color color, float minFontSize = 11.0f);
void DrawBoldCenteredText(Game* game, Font font, const char* text, Rectangle rect, float fontSize, float spacing, Color color);
void DrawBoldCenteredFittedText(Game* game, Font font, const char* text, Rectangle rect, float fontSize, float spacing, Color color, float minFontSize = 9.0f);
