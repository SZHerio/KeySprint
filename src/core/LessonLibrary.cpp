...
const std::vector<std::string> RussianCompositionParagraphs = {
    ...
    u8"Когда абзац заканчивается, нажми ввод и продолжай новый фрагмент без спешки. Важно сохранить тот же темп после перехода на новую строку.",
